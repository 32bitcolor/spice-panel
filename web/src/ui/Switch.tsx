...
export const Switch: React.FC<SwitchProps> = ({
  ...
  >
    <span className="relative h-[22px] w-[42px] bg-[var(--void)] shadow-[inset_0_0_0_1px_var(--steel)] transition [clip-path:polygon(4px_0,100%_0,100%_calc(100%-4px),calc(100%-4px)_100%,0_100%,0_4px)] group-data-[selected]:bg-accent/20 group-data-[selected]:shadow-[inset_0_0_0_1px_var(--accent),0_0_12px_-3px_var(--accent)] group-data-[focus-visible]:hud-glow">
